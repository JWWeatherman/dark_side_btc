...
> * Bitcoin Core coin - there is no Bitcoin Core coin and claiming the opposite is an obvious lie. Bitcoin Core is one of many bitcoin clients that would validate the whole bitcoin blockchain from the genesis block till today.